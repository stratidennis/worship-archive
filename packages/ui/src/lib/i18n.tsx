...
const ro = {
  ...
  'app.delete': 'Șterge',
  'app.print': 'Print / PDF',
  'powerpoint.action': 'PowerPoint',
  'powerpoint.title': 'Prezentările programului',
  'powerpoint.scanning': 'Se caută în dosarul PowerPoints…',
  'powerpoint.found': 'Găsit',
  'powerpoint.missing': 'Lipsește',
  ...
  'powerpoint.openFailed': 'Unele prezentări nu au putut fi deschise.',
  'powerpoint.browserHint':
    'În browser, fișierele se descarcă. Aplicațiile desktop le deschid în PowerPoint sau în aplicația implicită pentru prezentări.',
  'powerpoint.bandDesktopOnly':
    'Dosarul PowerPoints al trupei este disponibil în aplicația desktop Band.',
  ...
  'edit.unsavedBody': 'Salvează modificările înainte să pleci sau renunță la ele.',
  ...
  'sets.key': 'ton',
  'sets.performanceKey': 'tonalitate cântată - {key}',
  ...
  'performance.performanceKey': 'Tonalitate cântată {key}',
  'performance.transpose': 'Transpose {amount}',
  'performance.capo': 'Capo {fret}',
  'performance.yourKey': 'Ton',
  'performance.yourChords': 'Tonul tău {key}',
  'performance.pianoTranspose': 'Transpose {amount}',
  'performance.capoOption': 'Capo {fret}',
  'performance.shortSetup': 'capo {capo} · transpose {transpose}',
  ...
  'settings.powerpoints': 'Prezentări PowerPoint',
  'settings.powerpointsDir': 'Dosarul PowerPoints',
  'settings.choosePowerpointsDir': 'Schimbă dosarul…',
  'settings.revealPowerpointsDir': 'Deschide dosarul',
  'settings.powerpointsDirHint':
    'Sunt căutate și subdosarele. Prezentările nou create se salvează direct în acest dosar.',
...
const en: Record<TranslationKey, Entry> = {
  ...
  'app.print': 'Print / PDF',
  'powerpoint.action': 'PowerPoint',
  'powerpoint.title': 'PowerPoints for this set',
  'powerpoint.scanning': 'Searching the PowerPoints folder…',
  'powerpoint.found': 'Found',
  'powerpoint.missing': 'Missing',
  ...
  'powerpoint.openFailed': 'Some presentations could not be opened.',
  'powerpoint.browserHint':
    'In a browser, the files download. The desktop apps open them in PowerPoint or the default presentation app.',
  'powerpoint.bandDesktopOnly':
    'The Band PowerPoints folder is available in the installed Band desktop app.',
  ...
  'edit.unsavedBody': 'Save your changes before leaving, or discard them.',
  ...
  'sets.key': 'key',
  'sets.performanceKey': 'performance key - {key}',
  'sets.transpose': 'transpose',
  'sets.capo': 'capo',
  ...
  'performance.performanceKey': 'Performance key {key}',
  'performance.transpose': 'Transpose {amount}',
  'performance.capo': 'Capo {fret}',
  'performance.yourKey': 'Key',
  'performance.yourChords': 'Your key {key}',
  'performance.pianoTranspose': 'Transpose {amount}',
  'performance.capoOption': 'Capo {fret}',
  'performance.shortSetup': 'capo {capo} · transpose {transpose}',
  ...
  'settings.powerpoints': 'PowerPoint presentations',
  'settings.powerpointsDir': 'PowerPoints folder',
  'settings.choosePowerpointsDir': 'Change folder…',
  'settings.revealPowerpointsDir': 'Open the folder',
  'settings.powerpointsDirHint':
    'Subfolders are searched too. Newly created presentations are saved directly in this folder.',
